		...
		<div id="formsVote">
			...
			<div id="formVoteTeamA" class="formVote">
				<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
					...
					<input type="image" src="http://organizemyclub.com/img/voteformyteam/vote_a.png" border="0" name="submit" class="voteSubmitBtn" alt="PayPal - The safer, easier way to pay online!">
			...
			<div id="formVoteTeamB" class="formVote">
				<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
					...
					<input type="text" name="quantity" value="1" class="voteQuantity">
					<input type="image" src="http://organizemyclub.com/img/voteformyteam/vote_b.png" border="0" name="submit" class="voteSubmitBtn" alt="PayPal - The safer, easier way to pay online!">
					<img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
				</form>
